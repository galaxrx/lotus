...
const en = {
  ...
  order: {
    ...
    offerHint: "This is what you'd like to pay. You can offer above or below our estimate — painters choose which offers to take.",
  ...
  deposit: {
    ...
    howSteps: [
      ...
      "We share it — with no personal details — so a painter can take it on.",
  ...
  portal: {
    ...
    handleHint: "Letters and numbers — this becomes your studio's web address.",
    signIn: "Sign in",
  ...
  about: {
    ...
    story: [
      "Niloosa started with a frustration we kept running into. The art we loved most lived behind glass, in cities we rarely visited, in prices no one we knew could reach. Meanwhile the painters we admired — genuinely gifted people, many of them here in Iran — were doing extraordinary work that too few people ever saw.",
      "So we built a bridge. You choose a piece you love — a public-domain masterpiece, or an original from one of our painters — and say what you'd pay. A real artist takes it on and paints it by hand, for you. No factory prints, no middle-men marking things up beyond reason.",
...
const fa: Dictionary = {
  ...
  portal: {
    ...
    handleHint: "حروف و اعداد انگلیسی — این نشانی وب آتلیه‌ی شما می‌شود.",
    signIn: "ورود",
    signUp: "ساخت آتلیه",
    working: "یک لحظه…",
