...
const en = {
  ...
  about: {
    ...
    story: [
      "Niloosa started with a frustration we kept running into. The art we loved most lived behind glass, in cities we rarely visited, at prices no one we knew could reach. Meanwhile the painters we admired, genuinely gifted people, many of them here in Iran, were doing extraordinary work that too few people ever saw.",
      ...
      "Because sending money in and out of Iran is its own ordeal, we kept the money side deliberately simple and local: a deposit holds your commission, the painter starts, and you settle the rest on delivery. Everyone stays protected, and everyone gets paid.",
...
const fa: Dictionary = {
  ...
  order: {
    title: "پیشنهاد قیمت‌تان را بدهید",
    subtitle: "قیمتی را که برای این اثرِ دست‌نقاشی می‌پردازید بنویسید. آن را به نقاش‌هایمان می‌رسانیم؛ وقتی یکی‌شان بپذیرد، قدم بعد را با شما هماهنگ می‌کنیم.",
    summary: "سفارش شما",
    estimate: "برآورد ما",
    offerLabel: "پیشنهاد شما",
    offerHint: "این همان مبلغی است که مایلید بپردازید. می‌توانید بالاتر یا پایین‌تر از برآورد ما پیشنهاد بدهید؛ انتخاب با نقاش است.",
    lowOfferWarn: "این مبلغ خیلی پایین‌تر از برآورد ماست، پس شاید پیدا کردن نقاش کمی طول بکشد. با این حال می‌توانید بفرستید.",
    name: "نام شما",
    contact: "ایمیل یا شماره‌ی تماس",
    contactHint: "خصوصی می‌ماند. فقط پس از واریز بیعانه آن را با نقاش در میان می‌گذاریم.",
    address: "نشانی تحویل",
    ...
    successBody: "پیشنهادتان به دست ما رسید. آن را به نقاش‌هایمان می‌رسانیم و همین که یکی‌شان بپذیرد خبرتان می‌کنیم.",
    ref: "کد پیگیری",
  ...
  status: {
    offer_pending: "پیشنهاد دریافت شد",
    channel_posted: "برای نقاش‌ها ارسال شد",
    artist_matched: "یک نقاش پذیرفت",
    deposit_pending: "در حال بررسی بیعانه",
    deposit_confirmed: "بیعانه تأیید شد",
    in_progress: "در حال نقاشی",
    delivered: "تحویل شد",
    completed: "تکمیل شد",
    cancelled: "لغو شد",
  },
  deposit: {
    ...
    howTitle: "روند یک سفارش",
    howSteps: [
      "برای یک اثر پیشنهاد قیمت می‌دهید.",
      "آن را بدون هیچ مشخصات شخصی برای نقاش‌ها می‌فرستیم تا یکی‌شان بپذیرد.",
      "وقتی نقاشی پذیرفت، برای رزرو سفارش بیعانه می‌پردازید.",
      "همین که بیعانه تأیید شود، شما و نقاش به هم معرفی می‌شوید و کار روی بوم شروع می‌شود.",
      "باقی مبلغ را هنگام تحویل تسویه می‌کنید. سهم کوچکی به ما می‌رسد و بقیه از آنِ نقاش است.",
    ],
    awaitingTitle: "یک نقاش پذیرفت. بیایید سفارش را قطعی کنیم.",
    awaitingBody: "برای رزرو این سفارش و باز شدن ارتباط مستقیم با نقاش، بیعانه‌ی زیر را واریز کنید و کد پیگیری را وارد نمایید. باقی مبلغ هنگام تحویل پرداخت می‌شود.",
    depositLabel: "بیعانه‌ی قابل پرداخت",
    balanceLabel: "باقی‌مانده هنگام تحویل",
    payToTitle: "واریز به",
    cardLabel: "شماره کارت",
    holderLabel: "به نام",
    shebaLabel: "شبا",
    memoLabel: "این را در توضیح واریز بنویسید",
    copy: "کپی",
    copied: "کپی شد",
    codeLabel: "کد پیگیری بانکی",
    codeHint: "همان کدی که اپلیکیشن بانک بعد از واریز موفق نشان می‌دهد.",
    submitDeposit: "پرداخت کردم؛ ثبت کد",
    submitting: "در حال ثبت…",
    pendingTitle: "ممنون. در حال تأیید با بانک هستیم",
    pendingBody: "معمولاً چند ساعت طول می‌کشد. به‌محض تأیید بیعانه، شما و نقاش به هم معرفی می‌شوید و کار آغاز می‌شود.",
    revealedTitle: "به هم وصل شدید",
    revealedBody: "بیعانه‌تان ثبت شد. این نقاشی است که اثر شما را خلق می‌کند. هر وقت خواستید پیام بدهید.",
    artistLabel: "نقاش شما",
    progressBody: "بوم شما دست نقاش است. این صفحه را همراه با پیشرفت کار به‌روز می‌کنیم.",
    deliveredBody: "اثر شما تحویل داده شد. باقی مبلغ را مستقیم با نقاش تسویه کنید.",
    completedBody: "تمام شد. امیدواریم روی دیوارتان دلنشین باشد.",
    cancelledBody: "این سفارش به سرانجام نرسید. هر وقت خواستید می‌توانید پیشنهاد تازه‌ای بدهید.",
    anonNote: "تا پیش از تأیید بیعانه، شما و نقاش برای هم ناشناس می‌مانید. این عمدی است و امنیت هر دو طرف را حفظ می‌کند.",
    notConfigured: "اطلاعات واریز هنوز روی این سایت تنظیم نشده است.",
    error: "مشکلی پیش آمد. لطفاً دوباره تلاش کنید.",
  ...
  portal: {
    ...
    comingSoonBody: "به‌زودی نقاش‌ها می‌توانند اینجا آتلیه‌ی خودشان را باز کنند: یک نمایه‌ی دوزبانه، دیواری از آثارشان و پیشنهادهایی که به آن‌ها می‌خورد. کمی دیگر سر بزنید.",
    heroEyebrow: "برای هنرمندان",
    heroTitle: "آثارتان را نشان دهید. سفارش‌هایتان را خودتان انتخاب کنید.",
    heroBody: "یک آتلیه‌ی رایگان باز کنید، داستانتان را به فارسی و انگلیسی بنویسید، آثاری را که به آن‌ها می‌بالید بارگذاری کنید و قیمتی را که درست می‌دانید بگذارید. هر پیشنهادی که برایتان مناسب بود، مالِ شماست.",
    signInTitle: "خوش آمدید",
    signUpTitle: "آتلیه‌تان را بسازید",
    email: "ایمیل",
    password: "گذرواژه",
    displayName: "نام شما (همان‌طور که باید نمایش داده شود)",
    handle: "شناسه‌ی آتلیه",
    handleHint: "فقط حروف و اعداد انگلیسی. این نشانی وب آتلیه‌ی شما می‌شود.",
    signIn: "ورود",
    signUp: "ساخت آتلیه",
    working: "یک لحظه…",
    toSignUp: "تازه‌واردید؟ آتلیه باز کنید",
    toSignIn: "قبلاً آتلیه دارید؟ وارد شوید",
    signOut: "خروج",
    ...
    bioHint: "چند خط صادقانه. چه می‌کشید، چطور کار می‌کنید و چه چیزی شما را جذب می‌کند.",
    city: "شهر",
    ...
    publishProfile: "آتلیه‌ام عمومی نمایش داده شود",
    save: "ذخیره",
    saving: "در حال ذخیره…",
    saved: "ذخیره شد",
    addWork: "افزودن اثر",
    ...
    publishWork: "انتشار",
    publishWorkHint: "آثار منتشرشده در گالری عمومی آتلیه‌ها دیده می‌شوند.",
    deleteWork: "حذف",
    worksEmpty: "هنوز اثری ندارید. اولین اثرتان را اضافه کنید؛ یک دقیقه بیشتر طول نمی‌کشد.",
    profileFirst: "اول نمایه‌تان را ذخیره کنید، بعد آثارتان را اضافه کنید.",
  ...
  ateliers: {
    ...
    subtitle: "آثار اصیلِ هنرمندان نیلوسا. هر کدام برای فروش و هر کدام ساخته‌ی دست.",
    by: "اثرِ",
    forSale: "برای فروش",
    viewProfile: "دیدن آتلیه",
    empty: "نقاش‌های ما در حال آویختن نخستین آثارشان هستند. کمی دیگر سر بزنید.",
    priceOnRequest: "قیمت با هماهنگی",
  },
  about: {
    eyebrow: "درباره‌ی ما",
    title: "چرا نیلوسا را ساختیم",
    lead: "یک ایده‌ی ساده: شاهکارِ دست‌نقاشی جای‌ش روی دیوار خانه‌ی معمولی است، نه فقط موزه.",
    story: [
      "نیلوسا از دلخوری‌ای شروع شد که مدام به آن برمی‌خوردیم. هنری که بیش از همه دوستش داشتیم پشت شیشه بود، در شهرهایی که کمتر می‌دیدیم، با قیمت‌هایی که دست هیچ‌کسِ آشنا به آن نمی‌رسید. از آن‌طرف، نقاش‌هایی که تحسینشان می‌کردیم، آدم‌های واقعاً بااستعداد، بسیاری همین‌جا در ایران، کارهای درخشانی می‌کردند که چشم‌های کمی آن‌ها را می‌دید.",
      "پس یک پل ساختیم. شما اثری را که دوست دارید انتخاب می‌کنید، یک شاهکار از آثار آزاد یا اثری اصیل از یکی از نقاش‌هایمان، و می‌گویید چقدر می‌پردازید. یک هنرمند واقعی آن را می‌پذیرد و با دست، برای شما، نقاشی می‌کند. نه چاپِ کارخانه‌ای، نه واسطه‌ای که قیمت را بی‌دلیل بالا بکشد.",
      "چون جابه‌جایی پول به ایران و از ایران خودش دردسری است، سمت پرداخت را عمداً ساده و داخلی نگه داشتیم: بیعانه سفارش را رزرو می‌کند، نقاش شروع می‌کند و باقی را هنگام تحویل تسویه می‌کنید. هم همه در امان می‌مانند، هم دستمزد همه پرداخت می‌شود.",
      "همه‌ی ماجرا همین است: هنرِ خوب، ساخته‌ی دست، در دسترس، و درآمدی منصفانه برای کسانی که آن را می‌سازند.",
    ],
    valuesTitle: "به چه چیزهایی اهمیت می‌دهیم",
    values: [
    ...
    founderBio: [
      "نیلوفر انصافیان کمابیش از همان وقتی که یادش می‌آید طراحی کرده، نقاشی هم کرده است. مثل نقاش‌های قدیم یاد گرفت، با کپی‌کردن آثار استادان، ضربه به ضربه، تا انتخاب‌های آن‌ها به غریزه‌ی خودش تبدیل شد. بعد سال‌ها گشت تا دستِ خودش را در رنگ روغن و بوم پیدا کند.",
      "نیلوسا را به دلیل ساده‌ای راه انداخت: دوستانش مدام از او می‌خواستند تابلوهایی را که دوست داشتند اما هرگز نمی‌توانستند صاحبش شوند برایشان بکشد. یک سفارش شد چند سفارش، و آن‌ها شدند یک باور؛ اینکه هر کسی باید بتواند یک اثرِ واقعیِ دست‌ساز روی دیوارش داشته باشد، نه پوستری از آن.",
