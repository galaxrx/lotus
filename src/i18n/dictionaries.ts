...
const en = {
  ...
  portal: {
    ...
    handleHint: "Letters and numbers only. This becomes your studio's web address.",
    signIn: "Sign in",
...
const fa: Dictionary = {
  ...
  portal: {
    ...
    comingSoonTitle: "آتلیه‌ی هنرمندان تقریباً آماده است",
    comingSoonBody: "به‌زودی نقاش‌ها می‌توانند اینجا آتلیه‌ی خودشان را باز کنند: یک نمایه‌ی دوزبانه، دیواری از کارهای خودشان، و سفارش‌هایی که بهشان می‌خورد. کمی دیگر سر بزنید.",
    heroEyebrow: "برای هنرمندان",
    heroTitle: "کارتان را نشان بدهید، سفارش‌هایتان را خودتان انتخاب کنید.",
    heroBody: "یک آتلیه‌ی رایگان بسازید، قصه‌ی خودتان را به فارسی و انگلیسی بنویسید، کارهایی را که دوستشان دارید بگذارید و قیمتی را که حق می‌دانید تعیین کنید. هر سفارشی که به دلتان نشست، مالِ خودتان است.",
    signInTitle: "خوش آمدید",
    signUpTitle: "آتلیه‌تان را بسازید",
    email: "ایمیل",
    password: "گذرواژه",
    displayName: "نامتان (همان‌طور که باید نشان داده شود)",
    handle: "شناسه‌ی آتلیه",
    handleHint: "فقط حروف و عددِ انگلیسی. همین می‌شود نشانیِ وبِ آتلیه‌ی شما.",
    signIn: "ورود",
    signUp: "ساختِ آتلیه",
    working: "یک لحظه…",
    toSignUp: "تازه‌واردید؟ آتلیه بسازید",
    toSignIn: "از قبل آتلیه دارید؟ وارد شوید",
    signOut: "خروج",
    checkEmail: "چیزی نمانده. برای تأییدِ ایمیل، صندوقِ ورودی‌تان را ببینید و بعد وارد شوید.",
    dashboardTitle: "آتلیه‌ی شما",
    profileTab: "نمایه",
    worksTab: "آثار",
    bioEn: "درباره‌ی شما — انگلیسی",
    bioFa: "درباره‌ی شما — فارسی",
    bioHint: "چند خطِ صادقانه: چه می‌کشید، چطور کار می‌کنید و چه چیزی شما را می‌کشاند.",
    city: "شهر",
    ...
    workStyle: "سبک",
    workMedium: "متریال",
    workMediumHint: "مثلاً رنگ روغن روی بوم، آبرنگ، اکریلیک.",
    ...
    publishWork: "انتشار",
    publishWorkHint: "کارهای منتشرشده در گالریِ عمومیِ آتلیه‌ها دیده می‌شوند.",
    deleteWork: "حذف",
  ...
  ateliers: {
    ...
    subtitle: "کارهای اصیلِ نقاش‌های نیلوسا. هرکدام برای فروش، هرکدام ساخته‌ی دست.",
    by: "اثرِ",
    forSale: "برای فروش",
    viewProfile: "دیدنِ آتلیه",
    empty: "نقاش‌های ما دارند اولین کارهایشان را می‌چینند. کمی دیگر سر بزنید.",
    priceOnRequest: "قیمت با هماهنگی",
    buy: "خرید این اثر",
    buyTitle: "خرید این اثر",
    buySubtitle: "با یک بیعانه آن را رزرو کنید؛ باقیِ مبلغ موقعِ تحویل. همین که بیعانه تأیید شود، شما و هنرمند به هم معرفی می‌شوید.",
