...
const en = {
  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Pick a size and a frame, then say what you'd pay. We take your offer to our painters, without your details attached.",
      },
      {
  ...
  order: {
    ...
    subtitle: "Name the price you'd pay for this piece, hand-painted. We take it to our painters; when one accepts, we'll walk you through the next step.",
    summary: "Your commission",
    estimate: "Our estimate",
    offerLabel: "Your offer",
    offerHint: "This is what you'd like to pay. You can go above or below our estimate; painters choose which offers to take.",
    lowOfferWarn: "That's well under our estimate, so it may take longer to find a painter. You can still send it.",
    name: "Your name",
    ...
    successBody: "Your offer is with us. We'll post it to our painters and let you know the moment one takes it on.",
    ref: "Reference",
    backHome: "Back to home",
    browse: "Browse more paintings",
    error: "Something went wrong. Please try again.",
    demoNote: "Demo mode: the offer isn't persisted and Telegram delivery is stubbed until configured.",
  },
  ar: {
    title: "See it on your wall",
    start: "Start camera",
  ...
  deposit: {
    ...
    estimateLabel: "Our estimate",
    howTitle: "How a commission works",
    howSteps: [
      "You make an offer on a piece.",
...
const fa: Dictionary = {
  ...
  how: {
    ...
    steps: [
      ...
      {
        title: "قیمت‌تان را بگویید",
        body: "یک اندازه و یک قاب انتخاب کنید و بنویسید چقدر می‌پردازید. پیشنهادتان را بدون مشخصات شخصی به نقاش‌هایمان می‌رسانیم.",
      },
      {
        title: "نقاشی و تحویل",
        body: "وقتی نقاشی پذیرفت، بیعانه سفارش را قطعی می‌کند و شما دو نفر به هم معرفی می‌شوید. تابلو را روی بوم می‌کشد، با همان بافتِ قلم‌مو، امضایش می‌کند و به درِ خانه‌تان می‌رساند.",
      },
    ],
  },
  featured: {
  ...
  order: {
    title: "قیمتتان را پیشنهاد بدهید",
    subtitle: "بگویید برای این اثرِ دست‌ساز چقدر حاضرید بپردازید. پیشنهادتان را به نقاش‌ها می‌رسانیم؛ همین که یکی‌شان قبول کند، قدمِ بعد را با شما هماهنگ می‌کنیم.",
    summary: "سفارش شما",
    estimate: "برآورد ما",
    offerLabel: "پیشنهاد شما",
    offerHint: "این همان مبلغی است که دلتان می‌خواهد بپردازید. می‌تواند بالاتر یا پایین‌تر از برآورد ما باشد؛ تصمیمش با نقاش است.",
    lowOfferWarn: "این مبلغ خیلی پایین‌تر از برآورد ماست، برای همین شاید پیدا شدنِ نقاش کمی طول بکشد. ولی می‌توانید بفرستید.",
    name: "نام شما",
    ...
    submit: "ارسالِ پیشنهاد",
    submitting: "در حال ارسال…",
    cancel: "انصراف",
    successTitle: "پیشنهادتان ثبت شد",
    successBody: "پیشنهادتان به دستمان رسید. می‌رسانیمش به نقاش‌ها و تا یکی‌شان قبول کرد، خبرتان می‌کنیم.",
    ref: "کد پیگیری",
    backHome: "بازگشت به خانه",
    browse: "دیدن تابلوهای بیشتر",
    error: "مشکلی پیش آمد. لطفاً دوباره تلاش کنید.",
    demoNote: "حالت نمایشی: پیشنهاد ذخیره نمی‌شود و ارسال به تلگرام تا زمان پیکربندی غیرفعال است.",
  },
  ar: {
    title: "روی دیوار خانه ببینید",
  ...
  deposit: {
    ...
    estimateLabel: "برآورد ما",
    howTitle: "سفارش چطور پیش می‌رود",
    howSteps: [
      "برای یک اثر قیمت پیشنهاد می‌دهید.",
  ...
  about: {
    ...
    values: [
      ...
      { h: "انصاف برای هر دو طرف", b: "نقاش می‌گوید کارش چقدر می‌ارزد، خریدار می‌گوید چقدر می‌تواند بدهد؛ ما فقط این وسط را امن نگه می‌داریم." },
