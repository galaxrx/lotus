...
const en = {
  ...
  order: {
    ...
    codeTitle: "Your order code",
    keepNote: "Save this code. Any time, enter it on the “Track your order” page to see your status — no account, no password.",
    copy: "Copy",
    copied: "Copied",
  ...
  track: {
    ...
    subtitle: "Enter your order code to see where it stands. No account needed.",
    label: "Order code",
    placeholder: "NIL-XXXXXX",
    button: "See my order",
    hint: "The code we showed you when you ordered — like NIL-39C727.",
  },
  ar: {
    title: "See it on your wall",
    start: "Start camera",
  ...
  admin: {
    ...
    tokenTitle: "Niloosa · Escrow console",
    tokenPrompt: "Enter the admin token.",
    signIn: "Sign in",
    wrongToken: "Wrong token.",
    loadFailed: "Couldn't load orders. Try again.",
    transitionFailed: "Couldn't update the order. Try again.",
    refresh: "Refresh",
    empty: "No orders yet.",
    after: "after",
    offer: "Offer",
    ...
    noActions: "No further actions.",
    guideTitle: "How to run an order",
    guideSteps: [
      "A new order arrives as “Offer received”. Post the anonymised card (from Telegram) to your channel, then press “Shared with painters”.",
      "When a painter accepts, press “A painter accepted” — this asks the buyer to pay the deposit.",
      "The buyer pays and submits their tracking code; the order turns to “Checking your deposit” and the code shows here. Check your bank.",
      "Once the money has arrived, press “Deposit confirmed” — this introduces the buyer and painter to each other.",
      "As the work moves along, press “Being painted”, then “Delivered” when it ships.",
      "When the balance is settled and it’s done, press “Complete”. Use “Cancelled” if an order falls through.",
    ],
  },
  deposit: {
    ...
    payHowTitle: "How to pay your deposit",
    payHowSteps: [
      "Open your banking app and transfer the amount below to the card shown — an ordinary card-to-card transfer. You pay through your own bank, not on this page.",
      "Put the reference in the transfer note so we can match your payment.",
      "After the transfer, your bank gives you a tracking code. Paste it in the box below and submit.",
      "We check it against our account, then connect you with your painter. You pay the balance on delivery.",
    ],
...
const fa: Dictionary = {
  ...
  order: {
    ...
    codeTitle: "کد پیگیری سفارش شما",
    keepNote: "این کد را ذخیره کنید. هر وقت خواستید، آن را در صفحه‌ی «پیگیری سفارش» وارد کنید تا وضعیت سفارش را ببینید. نه حساب می‌خواهد نه رمز.",
    copy: "کپی",
    copied: "کپی شد",
  ...
  track: {
    title: "پیگیری سفارش",
    subtitle: "کد سفارش‌تان را وارد کنید تا وضعیتش را ببینید. نیازی به حساب کاربری نیست.",
    label: "کد سفارش",
    placeholder: "NIL-XXXXXX",
    button: "دیدن سفارش من",
    hint: "همان کدی که موقع سفارش نشانتان دادیم؛ مثل NIL-39C727.",
  },
  ar: {
    title: "روی دیوار خانه ببینید",
  ...
  admin: {
    title: "کنسول سفارش‌ها",
    tokenTitle: "نیلوسا · کنسول سفارش‌ها",
    tokenPrompt: "توکن مدیر را وارد کنید.",
    signIn: "ورود",
    wrongToken: "توکن اشتباه است.",
    loadFailed: "سفارش‌ها بارگذاری نشد. دوباره تلاش کنید.",
    transitionFailed: "به‌روزرسانی سفارش انجام نشد. دوباره تلاش کنید.",
    refresh: "تازه‌سازی",
    ...
    deliverTo: "ارسال به",
    note: "یادداشت",
    depositCode: "کد رهگیری",
    noActions: "کار دیگری نمانده.",
    guideTitle: "سفارش را چطور پیش ببرید",
    guideSteps: [
      "سفارش تازه با وضعیت «پیشنهاد رسید» می‌آید. کارت بی‌نام را (از تلگرام) روی کانال بگذارید و بعد «برای نقاش‌ها فرستاده شد» را بزنید.",
      "وقتی یک نقاش قبول کرد، «یک نقاش قبول کرد» را بزنید؛ این‌طور از خریدار خواسته می‌شود بیعانه را بدهد.",
      "خریدار پرداخت می‌کند و کد رهگیری را می‌فرستد؛ سفارش «در حال بررسیِ بیعانه» می‌شود و کد همین‌جا نشان داده می‌شود. حساب‌تان را چک کنید.",
      "همین که پول رسید، «بیعانه تأیید شد» را بزنید؛ این‌طور خریدار و نقاش به هم معرفی می‌شوند.",
      "با پیش‌رفتنِ کار، «در حال کشیدن» و بعد موقع ارسال «تحویل شد» را بزنید.",
      "وقتی باقیِ پول تسویه شد و کار تمام شد، «تمام شد» را بزنید. اگر سفارشی به هم خورد، «لغو شد» را بزنید.",
    ],
  },
  deposit: {
    ...
    payHowTitle: "بیعانه را چطور پرداخت کنید",
    payHowSteps: [
      "اپ بانک‌تان را باز کنید و مبلغ زیر را کارت‌به‌کارت به شماره‌کارتی که نشان داده شده واریز کنید. پرداخت از طریق بانک خودتان انجام می‌شود، نه روی این صفحه.",
      "کد سفارش را در توضیح واریز بنویسید تا بتوانیم پرداخت‌تان را پیدا کنیم.",
      "بعد از واریز، بانک یک کد رهگیری به شما می‌دهد. آن را در کادر پایین بگذارید و ثبت کنید.",
      "واریز را با حساب خودمان چک می‌کنیم و بعد شما را به نقاش وصل می‌کنیم. باقی مبلغ را موقع تحویل می‌دهید.",
    ],
