...
const en = {
  ...
  order: {
    ...
    keepNote: "Save this link or your code — it's how you'll check your order later. No account, no password.",
...
const fa: Dictionary = {
  ...
  order: {
    ...
    keepNote: "این نشانی یا کد را ذخیره کنید؛ بعداً با همین سفارش‌تان را می‌بینید. نه حساب می‌خواهد نه رمز.",
