  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Pick a size and a frame, then confirm. Your request goes straight to the painter on Telegram.",
      },
      {
        title: "Painted and delivered",
        body: "The painter paints it on canvas, brush texture and all, signs it, and ships it to your door.",
      },
    ],
  },
  featured: {
  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "یک اندازه و یک قاب انتخاب کنید و تأیید بزنید. سفارشتان یک‌راست در تلگرام به دست نقاش می‌رسد.",
      },
      {
        title: "نقاشی و تحویل",
        body: "نقاش تابلو را روی بوم می‌کشد، با همان بافتِ قلم‌مو، امضایش می‌کند و به درِ خانه‌تان می‌رساند.",
      },
    ],
  },
  featured: {
